...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("mitUnit", [], factory);
	else if(typeof exports === 'object')
		exports["mitUnit"] = factory();
	else
		root["mitUnit"] = factory();
})(this, function() {
...
function getValueOfUnit(unitInput) {
  var unit = unitInput ? unitInput.toLowerCase() : 'tnb';
  var unitValue = unitMap[unit]; // eslint-disable-line

  if (typeof unitValue !== 'string') {
    throw new Error('[mitjs-unit] the unit provided ' + unitInput + ' doesn\'t exists, please use the one of the following units ' + JSON.stringify(unitMap, null, 2));
  }
...
function toWei(tnbInput, unit) {
  var tnb = numberToString(tnbInput); // eslint-disable-line
  var base = getValueOfUnit(unit);
  var baseLength = unitMap[unit].length - 1 || 1;

  // Is it negative?
  var negative = tnb.substring(0, 1) === '-'; // eslint-disable-line
  if (negative) {
    tnb = tnb.substring(1);
  }

  if (tnb === '.') {
    throw new Error('[mitjs-unit] while converting number ' + tnbInput + ' to wei, invalid value');
  }

  // Split it into a whole and fractional part
  var comps = tnb.split('.'); // eslint-disable-line
  if (comps.length > 2) {
    throw new Error('[mitjs-unit] while converting number ' + tnbInput + ' to wei,  too many decimal points');
  }
  ...
  if (fraction.length > baseLength) {
    throw new Error('[mitjs-unit] while converting number ' + tnbInput + ' to wei, too many decimal places');
  }
...
;
//# sourceMappingURL=mitjs-unit.js.map