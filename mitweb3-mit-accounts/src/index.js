...
var MMitod = require('mitweb3-core-method');
var Promise = require('any-promise');
var Account = require("mit-lib/lib/account");
var Hash = require("mit-lib/lib/hash");
var RLP = require("mit-lib/lib/rlp");
var Nat = require("mit-lib/lib/nat");
var Bytes = require("mit-lib/lib/bytes");
...
var Accounts = function Accounts() {
    ...
    // attach mMitods to this._MitereumCall
    this._MitereumCall = {};
    _.each(_MitereumCall, function (method) {
        method.attachToObject(_this._MitereumCall);
...
Accounts.prototype.signTransaction = function signTransaction(tx, privateKey, callback) {
    ...
    // Otherwise, get the missing info from the Mitereum Node
    return Promise.all([
        isNot(tx.chainId) ? _this._MitereumCall.getId() : tx.chainId,
        isNot(tx.gasPrice) ? _this._MitereumCall.getGasPrice() : tx.gasPrice,
        isNot(tx.nonce) ? _this._MitereumCall.getTransactionCount(_this.privateKeyToAccount(privateKey).address) : tx.nonce
    ]).then(function (args) {
...
Accounts.prototype.hashMessage = function hashMessage(data) {
    ...
    var preamble = "\x19Mitereum Signed Message:\n" + message.length;
    var preambleBuffer = Buffer.from(preamble);
    var MitMessage = Buffer.concat([preambleBuffer, messageBuffer]);
    return Hash.keccak256s(MitMessage);
};
