 ...
 *
 *  var Contract = require('mitweb3-mit-contract');
...
var Subscription = require('mitweb3-core-subscriptions').subscription;
...
var Contract = function Contract(jsonInterface, address, options) {
    ...
    if(!(this instanceof Contract)) {
        throw new Error('Please use the "new" keyword to instantiate a mitweb3.mit.contract() object!');
    }
...
Contract.prototype._executeMethod = function _executeMethod(){
    ...
    if(args.generateRequest) {
        ...
        if(args.type === 'call') {
            ...
            payload.method = 'mit_call';
            payload.format = this._parent._decodeMethodReturn.bind(null, this._method.outputs);
        } else {
            payload.method = 'mit_sendTransaction';
        }
        ...
        switch (args.type) {
            case 'estimate':
                ...
                var estimateGas = (new Method({
                    ...
                    accounts: ethAccounts, // is mit.accounts (necessary for wallet signing)
            ...
            case 'send':
                ...
                var sendTransaction = (new Method({
                    ...
                    requestManager: _this._parent._requestManager,
                    accounts: _this.constructor._ethAccounts || _this._ethAccounts, // is mit.accounts (necessary for wallet signing)
                    defaultAccount: _this._parent.defaultAccount,
                    defaultBlock: _this._parent.defaultBlock,
