...
var errors = require('mitweb3-core-helpers').errors;
var formatters = require('mitweb3-core-helpers').formatters;
var utils = require('mitweb3-utils');
var promiEvent = require('mitweb3-core-promievent');
...
Method.prototype._confirmTransaction = function (defer, result, payload) {
    ...
    // attach methods to this._mitCall
    var _mitCall = {};
    _.each(_mitCalls, function (mthd) {
        mthd.attachToObject(_mitCall);
    ...
    var checkConfirmation = function (existingReceipt, isPolling, err, blockHeader, sub) {
        if (!err) {
            ...
            return (existingReceipt ? promiEvent.resolve(existingReceipt) : _mitCall.getTransactionReceipt(result))
            ...
            .then(function(receipt) {
                ...
                if (isContractDeployment && !promiseResolved) {
                    ...
                    _mitCall.getCode(receipt.contractAddress, function (e, code) {
    ...
    var startWatching = function(existingReceipt) {
        ...
        if (_.isFunction(this.requestManager.provider.on)) {
            _mitCall.subscribe('newBlockHeaders', checkConfirmation.bind(null, existingReceipt, false));
        } else {
    ...
    _mitCall.getTransactionReceipt(result)
    .then(function(receipt) {
        if (receipt && receipt.blockHash) {
            if (defer.eventEmitter.listeners('confirmation').length > 0) {
...
Method.prototype.buildCall = function() {
    var method = this,
        isSendTx = (method.call === 'mit_sendTransaction' || method.call === 'mit_sendRawTransaction'); // || method.call === 'personal_sendTransaction'
    ...
    var send = function () {
        ...
        var sendRequest = function(payload, method) {
            ...
            if (method && method.accounts && method.accounts.wallet && method.accounts.wallet.length) {
                ...
                // MIT_SENDTRANSACTION
                if (payload.method === 'mit_sendTransaction') {
                    ...
                    // MIT_SIGN
                } else if (payload.method === 'mit_sign') {
