 ...
 * It's also responsible for polling the mit node for incoming messages
...
RequestManager.providers = {
    WebsocketProvider: require('mitweb3-providers-ws'),
    HttpProvider: require('mitweb3-providers-http'),
    IpcProvider: require('mitweb3-providers-ipc')
};
 ...
 * @param {String} type         the subscription namespace (mit, personal, etc)
